/* Background Beams - Aceternity-style moving light dots along SVG paths */
(function () {
  'use strict';
  var PATHS = [
  ...
  function initBeams(el) {
    ...
    stop1.setAttribute('offset', '0%'); stop1.setAttribute('stop-color', '#a855f7'); stop1.setAttribute('stop-opacity', '0.5');
    ...
    PATHS.forEach(function (d, i) {
      ...
      path.setAttribute('stroke', 'url(#beam-grad)');
      ...
      anim.setAttribute('begin', (-i * 0.42) + 's');
  ...
  document.querySelectorAll('.beams').forEach(initBeams);
})();
